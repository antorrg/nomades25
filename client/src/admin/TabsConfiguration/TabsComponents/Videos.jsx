...
const Videos = () => {
  ...
  return (
    <section className="container-fluid">
      ...
      <VideoLayout activeTab={activeTab} handleTabChange={handleTabChange}>
        {activeTab === "facebook" && <FaceVideoView media={media} />}
        {activeTab === "instagram" && <InstVideoView media={media} />}
        {activeTab === "youtube" && <YouTubeVideoView media={media} />}
      </VideoLayout>
    </section>
  );
};
